...
<body>
    ...
    <div class="container-fluid">
                                ...
                                <ul class="horizontal-list">
                                    ...
                                    <li><a href="#" class="btn btn-secondary" id="btn-add-guest" data-toggle="modal"
                                            data-target="#"><i class="material-icons">&#xE147;</i> <span>Add New
                                                User</span></a></li>
                                    <li><a href="#" onClick="refreshTable();" class="btn btn-secondary"
                                            data-target="#"><i class="fa fa-refresh"></i>
                                    ...
                                    foreach ($data->users as $key => $c) {
                                        ...
                                        <tr class="view <?php echo $c->qr_code_status == 1 ? 'bg-success' : '' ?>"
                                            ...
                                            <td style="width:158px;">
                                                ...
                                                <a href="#" type="button" data-id="<?php echo $c->id; ?>"
                                                    class="delete btn-delete-guest-modal" title="Delete"
                                                    data-toggle="tooltip"><i class="fa fa-trash"></i></a>
                                                <a href="#" type="button" data-id="<?php echo $c->id; ?>"
                                                    data-name="<?php echo $c->name; ?>"
                                                    data-table="<?php echo $c->table_number; ?>"
                                                    class="delete btn-assign-guest-modal" title="Assign table slot"
        ...
        <!-- Delete Modal -->
        <div class="modal fade" id="delete-user-modal" tabindex="-1" role="dialog" aria-labelledby="#"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <!-- <div class="overlay">
        ...
        <!-- Assign Modal -->
        <div class="modal fade" id="assign-user-modal" tabindex="-1" role="dialog" aria-labelledby="#"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <!-- <div class="overlay">
            ...
            $(document).ready(function () {
                ...
                $(document).on('click', '#btn-assign-guest', function () {
                    ...
                    if (table_number != null) {
                        ...
                        // Send AJAX POST request
                        $.ajax({
                            url: '<?php echo base_url('admin/table-assignment') ?>', // URL to the controller method
                            type: 'POST',
                            data: { user_id: user_id, table_number: table_number },
                            dataType: 'json',
                            success: function (response) {
                                // Handle success
                                toastr.success(response.message);
                    ...
                    success: function (response2) {
                        ...
                        $.each(response2.users, function (index, item) {
                            html += '<tr class="view ' + (item.qr_code_status == 1 ? 'bg-success' : '') + '" data-id="' + item.id + '">' +
                                ...
                                '<a href="#" type="button" data-id="' + item.id + '" data-name="' + item.name + '" class="delete btn-assign-guest-modal" data-table="' + item.table_number + '"title="Assign table slot" data-toggle="tooltip"><i class="fa fa-table"></i></a>' +
                        ...
                        for (var ctr = 1; ctr <= 10; ctr++) {
                            ...
                            tableNum += '<option value="' + ctr + '" ' + (remS == 0 ? 'disabled' : '') + '>' + ctr + '(Slots: ' + (remS == 0 ? 'Full' : remS) + ')</option>';
